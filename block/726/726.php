<html>
    <head>
        ...
        $less = new lessc;
        $less->compileFile('less/726.less', 'css/726.css');
        ?>
                        ...
                        <div class="col-md-7">
                            <div class="input-box">
                                <div class="input_inner">
                                    <input type="text" name="email" title="Sign up for our" class="input-text" placeholder="Enter your email address ...">
                                </div>
                            ...
                            <div class="col-md-4 col-sm-12 footer-border-left-1">
                                ...
                                <div id="block_1" >
                                    <ul>
                                        ...
                                        <li>
                                            <div ><a href="#" target="_blank">support@templatemela.com</a></div>
                                        </li>
