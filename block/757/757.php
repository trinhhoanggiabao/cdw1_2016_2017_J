...
<html>
    ...
    <head>
        ...
        <link href="css/757.css" rel="stylesheet" type="text/css" />
        <?php
        if (!class_exists('lessc')) {
            include ('./libs/lessc.inc.php');
        }
        $less = new lessc;
        $less->compileFile('less/757.less', 'css/757.css');
        ?>
                                            ...
                                            <ul class="clr">  
                                                <li class="item active">
                                                    <figure class="small-img">
                                                        <img src="images/img-chitiet-1.png" alt=""/>
                                                    </figure>
                                                    <figure class="small-img">
                                                        <img src="images/img-chitiet-2.png" alt=""/>
                                                    </figure>
                                                    <figure class="small-img">
                                                        <img src="images/img-chitiet-3.png" alt=""/>
                                                    </figure>
                                                </li>
                                                <li class="item">
                                                    <figure class="small-img">
