                                            ...
                                            <div class="detail_right">
                                                ...
                                                <div class="product-options">
                                                    ...
                                                    <div class="color-price">
                                                        <input type="radio" name="channelcost" value="10.00" onClick="test(this);" />
                                                        <label>black <span> <em>+</em>$10.00</span></label>
                                                        <br />
                                                        <input type="radio" name="channelcost" value="30.00" onClick="test(this);" />
                                                        <label>brown <span> <em>+</em>$30.00</span></label>
                                                        <br />
                                                        <input type="radio" name="channelcost" value="50.00" onClick="test(this);" />
                                                        <label>gray <span> <em>+</em>$50.00</span></label>
                                                        <br />
                                                    </div>
                                                    ...
                                                    <div class="size-price">
                                                        <input type="checkbox" name="channelcost" value="10.00" onClick="test(this);" />
                                                        <label>black <span> <em>+</em>$10.00</span></label>
                                                        <br />
                                                        <input type="checkbox" name="channelcost" value="30.00" onClick="test(this);" />
                                                        <label>brown <span> <em>+</em>$30.00</span></label>
                                                        <br />
                                                        <input type="checkbox" name="channelcost" value="50.00" onClick="test(this);" />
                                                        <label>gray <span> <em>+</em>$50.00</span></label>
                                                        <br />
                                                    </div>
                                                    ...
                                                    <div class="tabs-live">
                                                        <div class="tab-content">
                                                            ...
                                                            <div id="newproducts2" class="tab-pane fade  ">
                                                                <p><span> <strong>About Me :</strong> </span> LOVE are renowned for their cute as a button skater Floral Woven Skater Dress is no exception! Flower power and Japanese print influences are big news.
                                                                    <br>
                                                                    <br> <span> <strong>Composition :</strong> 100% POLYESTER </span>
                                                                    <br> <span> <strong>Example Shown :</strong> SIZE XS, Hem to Hem 84cm OR 33 ' </span></p>
                                                            </div>
