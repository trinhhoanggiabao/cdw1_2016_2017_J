        ...
        <div class="type-L">
            <div class="type-34">
                <div class="container">
                    <div class="col-md-3">
                        <div class="row">
                            <div class="type-L-home-categories">
                                <div class="mod-custom-21">               
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="box category">
                                                    <div class="box-heading"><h3><i class="fa fa-bars" aria-hidden="true"></i>Categories</h3></div>

                                                    <div class="box-category">
                                                        <ul class="cate">
                                                            <li>
                                                                <a href="">Sound devices<i class="fa fa-angle-right"></i></a>
                                                            </li>
                                                            <li>
                                                                <a href="#">Video game consoles</a>
                                                            </li>
                                                            <li>
                                                                <a href="#">Cell/mobile/wireless phones</a>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <ul >     
                                                                ...
                                                                <li class="item">
                                                                    ...
                                                                    <div class="aa "><div class="row">
                                                                            <div class="col-xs-12 col-md-3" >
                                                                                <div class="image">
                                                                                    <img src="images/product-52-760x550.png"  />
                                                                ...
                                                                <li class="item">
                                                                    ...
                                                                    <div class="aa "><div class="row">
                                                                            <div class="col-xs-12 col-md-3" >
                                                                                <div class="image">
                                                                                    <img src="images/product-7-760x550.png"  />
                                                                ...
                                                                <li class="item">
                                                                    ...
                                                                    <div class="aa"><div class="row">
                                                                            <div class="col-xs-12 col-md-3">
                                                                                <div class="image">
                                                                                    <img src="images/product-34-760x550.png" />
                                ...
                                <div id="myCarousel" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            ...
                                            <div class="col-md-6">
                                                <div class="right" class="carousel">
                                                    <div class="top-right">
                                                        <h1> iPhone 6 </h1>
                                                    </div>
