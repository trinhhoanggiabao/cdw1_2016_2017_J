...
<html>
    ...
    <head>
        ...
        <link href="css/type-761.css" rel="stylesheet" type="text/css" />
        <?php
        if (!class_exists('lessc')) {
            include ('./libs/lessc.inc.php');
        }
        $less = new lessc;
        $less->compileFile('less/756.less', 'css/756.css');
        ?>
        <link href="css/756.css" rel="stylesheet" type="text/css" />
                                                    ...
                                                    <div class="column" style="margin-right : 15px;">
                                                        ...
                                                        <div class="group-btn">
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <a href="#" class="glyphicon glyphicon-check"></a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                ...
                                <div class="row">
                                    <div class="nav">
                                        ...
                                        <div class="btn">
                                            <ul>
                                                <li>
                                                    <a href="#myFeatured" data-slide="prev"> <span class="glyphicon glyphicon-chevron-up"> </span></a>
                                                </li>
                                                <li>
                                                    <a href="#myFeatured" data-slide="next"> <span class="glyphicon glyphicon-chevron-down"> </span></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
